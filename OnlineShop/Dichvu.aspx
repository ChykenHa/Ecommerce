...
<asp:Content ID="BannerContent" ContentPlaceHolderID="BannerContent" runat="server">
    <asp:Image ID="ServicesBanner" runat="server" ImageUrl="~/Assets/Images/Banner_Ser.png" AlternateText="Dịch Vụ Banner" />
</asp:Content>
        ...
        <div class="services-grid">
            <div class="service-item">
                <div class="service-icon">
                    <asp:Image ID="DeliveryIcon" runat="server" ImageUrl="~/Assets/Images/Ship.png" AlternateText="Giao Hàng" />
                </div>
            ...
            <div class="service-item">
                <div class="service-icon">
                    <asp:Image ID="ReturnIcon" runat="server" ImageUrl="~/Assets/Images/Doitra.png" AlternateText="Đổi Trả" />
                </div>
                <div class="service-content">
            ...
            <div class="service-item">
                <div class="service-icon">
                    <asp:Image ID="ConsultIcon" runat="server" ImageUrl="~/Assets/Images/Tuvan.png" AlternateText="Tư Vấn" />
                </div>
                <div class="service-content">
            ...
            <div class="service-item">
                <div class="service-icon">
                    <asp:Image ID="WarrantyIcon" runat="server" ImageUrl="~/Assets/Images/Baohanh.png" AlternateText="Bảo Hành" />
                </div>
                <div class="service-content">
            ...
            <div class="service-item">
                <div class="service-icon">
                    <asp:Image ID="MemberIcon" runat="server" ImageUrl="~/Assets/Images/Thanhvien.png" AlternateText="Thành Viên" />
                </div>
                <div class="service-content">
            ...
            <div class="service-item">
                <div class="service-icon">
                    <asp:Image ID="GiftIcon" runat="server" ImageUrl="~/Assets/Images/Quatang.png" AlternateText="Quà Tặng" />
                </div>
                <div class="service-content">
