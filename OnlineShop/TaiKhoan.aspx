    ...
    <div class="account-container">
        <div class="account-header">
            <div class="account-avatar">
                <asp:Image ID="UserAvatar" runat="server" ImageUrl="~/Assets/Images/user-placeholder.jpg" AlternateText="Avatar" />
            </div>
        ...
        <div id="orders" class="tab-content">
            ...
            <div class="order-list">
                    ...
                    <ItemTemplate>
                        <div class="order-item">
                            <div class="order-header">
                                <div class="order-number">Đơn hàng #<%# Eval("id_donhang") %></div>
                                <asp:Literal ID="litOrderStatus" runat="server"></asp:Literal>
                                <div class="order-date"><%# Eval("ngaydat", "{0:dd/MM/yyyy HH:mm}") %></div>
                            </div>
                            <div class="order-content">
                                <div class="order-info">
                                    <p><strong>Người nhận:</strong> <%# Eval("hoten") %></p>
                                    <p><strong>Số điện thoại:</strong> <%# Eval("sodienthoai") %></p>
                                ...
                                <div class="order-footer">
                                    <div class="order-total">Tổng tiền: <%# Eval("tongtien", "{0:N0}") %>₫</div>
                                    <asp:Button ID="btnViewDetails" runat="server" 
                                        Text="Xem Chi Tiết" 
                                        CssClass="btn-view-details" 
                                        OnClick="ViewOrderDetails_Click" 
                                        CommandArgument='<%# Eval("id_donhang") %>' />
                                </div>
                            </div>
                        </div>
                    </ItemTemplate>
                ...
                <asp:Panel ID="pnlNoOrders" runat="server" Visible="false" CssClass="no-orders">
                    <div style="text-align: center; padding: 60px 20px; color: #666;">
                        <i class="fas fa-shopping-bag" style="font-size: 4em; margin-bottom: 20px; opacity: 0.3;"></i>
                        <h3>Chưa có đơn hàng nào</h3>
                        <p>Bạn chưa đặt đơn hàng nào. Hãy khám phá sản phẩm của chúng tôi!</p>
                        <a href="SanPham.aspx" class="btn-save" style="display: inline-block; margin-top: 20px; text-decoration: none;">
                            Mua sắm ngay
                        </a>
                    </div>
                </asp:Panel>
